...
public class CodeGenTests {
	...
	@DisplayName("stringConcatOps")
	@Test
	public void stringConcatOps(TestInfo testInfo) throws Exception {
		String input = """
				BEGIN
				! "red" + "blue";
				END
	...
	@DisplayName("statementIf")
	@Test
	public void statementIf(TestInfo testInfo) throws Exception {
		String input = """
    			IF 5>=(3-2) THEN
					BEGIN
						!"Done";
